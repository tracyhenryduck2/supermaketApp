...
import android.widget.ImageView;
 ...
 public class ZoomImageView extends ImageView {
     ...
     * 记录手指在纵坐标方向上的移动距离
     ...
     private static final int MAX_DOUBLE_CLICK_INTERVAL = 50;  
     int mDownX = 0;  
     int mDownY = 0;  
     int mTempX = 0;  
     int mTempY = 0;  
     ...
     private Singlecallback sng;
     
     public Singlecallback getSng() {
		return sng;
	}

	public void setSng(Singlecallback sng) {
		this.sng = sng;
	}
	...
	Runnable mTimerForUpEvent = new Runnable() {  
     ...
     private void zoom(Canvas canvas) {
         ...
         if(sourceBitmap!=null)  canvas.drawBitmap(sourceBitmap, matrix, null);
     }
